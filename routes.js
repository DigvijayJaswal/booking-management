...
router.post('/user/createUser', validator.body(validation.newUser), auth.verifyApiKey, userController.registerNewUser);
...
// * This route is to upload file limit to 3mb
